...
export type DemoType = 'doc-walkthrough' | 'doc-card' | 'triage-walkthrough' | 'triage-card' | 'fireworks-case-study' | 'full-stack-architecture' | 'oauth-db-demo' | 'ai-web-embedding' | 'local-db-sqlite' | null
